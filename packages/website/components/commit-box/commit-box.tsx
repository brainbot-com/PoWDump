...
function CommitBox() {
  const activeCommitBoxSwitchItem = useStore(state => state.activeCommitBoxSwitchItem)
  ...
  return (
    <div className="container mx-auto">
      ...
      >
        <div>
          <div className="font-semibold text-2xl">Dump</div>
        </div>
        {/*<CommitBoxSwitchButtonBar />*/}
        {activeCommitBoxSwitchItem === 'ethPoW' ? <CommitBoxEthPow /> : <CommitBoxEthToTl />}
