        ...
        <Popover className="relative">
            {({open}) => (
                <>
                    ...
                    >
                        <Popover.Panel
                            className="absolute z-10 left-0 transform -translate-x-0 mt-3 px-2 w-screen max-w-[200px] sm:px-0">
                            <div
                                className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden border border-zinc-700">
