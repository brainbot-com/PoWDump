...
function QrCodeScannerModal(props: Props) {
  ...
  return (
    <Modal isOpen={props.isOpen} style={customStyles} onRequestClose={props.onRequestClose}>
      <div className="w-96">
        <QrScanner delay={300} onError={props.onError} onScan={handleScan} style={{ width: '100%' }} />
      </div>
    </Modal>
  )
}
