...
function NavBarSwitchButtonBar() {
  ...
  const activeNavBarSwitchItem = useStore(state => state.activeNavBarSwitchItem)
  const setActiveNavBarSwitchItem = useStore(state => state.setActiveNavBarSwitchItem)
